...
Route::get('ListCustoimsationCategory/{page}','RestaurantAdmin\CustomisationCategoryController@ListCustoimsationCategory')
	->middleware('auth:restaurant');
Route::get('getCustomisationCategory/{id}','RestaurantAdmin\CustomisationCategoryController@getCustomisationCategory')
->middleware('auth:restaurant');
...
Route::post('importDishes','RestaurantAdmin\DishesImportController@importDishes')->middleware('auth:restaurant');
...
Route::post('getOrders','RestaurantAdmin\OrderManagementController@getOrders')->middleware('auth:restaurant');
...
Route::post('updateTakeAwayOrder','RestaurantAdmin\OrderManagementController@updateTakeAwayOrder')->middleware('auth:restaurant');  