...
import { deliveryBoyService} from './viewtran.service';
import { Router } from '@angular/router';
import { localisation } from 'src/localisation/localisation';
import { ModalDismissReasons, NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { deliveryboyList } from './viewtran.model';
import Swal from 'sweetalert2';
@Component({
  selector: 'app-viewtran',
  templateUrl: './viewtran.component.html',
  styleUrls: ['./viewtran.component.css']
})
export class ViewtranComponent implements OnInit {
