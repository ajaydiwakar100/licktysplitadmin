...
export class ReportsService {
  ...
  getReportData() {
    return this.http.get(this.baseUrl + 'getReportsData', {
  ...
  reportsSendData(Data) {
    return this.http.post(this.baseUrl + 'reportSearch', Data, {
      headers: this.httpHeaders,
      observe: 'response'
    });
  }
  outlet(Data) {
    return this.http.post(this.baseUrl + 'getPayOutletByRestaurant', Data, {
      headers: this.httpHeaders,
      observe: 'response'
    });
  }
