...
@Component({
  selector: 'app-register-add-mail',
  templateUrl: './register-add-mail.component.html',
  styleUrls: ['./register-add-mail.component.css']
})
export class RegisterAddMailComponent implements OnInit {
        ...
        response => {
          if (response.body['error'] === 'true' ) {
            ...
            Swal({
              ...
              this.router.navigateByUrl('/registerMail');
            });
          }
